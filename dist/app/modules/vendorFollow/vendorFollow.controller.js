...
exports.VendorFollowController = void 0;
const http_status_1 = __importDefault(require("http-status"));
const sendResponse_1 = __importDefault(require("../../utils/sendResponse"));
const catchAsync_1 = __importDefault(require("../../utils/catchAsync"));
const vendorFollow_service_1 = require("./vendorFollow.service");
const addVendorFollower = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const vendorFollowData = req.body;
    const result = yield vendorFollow_service_1.VendorFollowServices.addFollowersIntoDB(vendorFollowData);
