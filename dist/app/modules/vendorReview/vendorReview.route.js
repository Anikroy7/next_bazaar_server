...
router.get('/:vendorId/:reviewId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), vendorReview_controller_1.VendorReviewController.getVendorReview);
router.patch('/:vendorId/:reviewId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), vendorReview_controller_1.VendorReviewController.updateVendorReview);
router.delete('/:vendorId/:reviewId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), vendorReview_controller_1.VendorReviewController.deleteVendorReview);
