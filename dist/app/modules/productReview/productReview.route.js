...
router.get('/:productId/:reviewId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.CUSTOMER), productReview_controller_1.ProductReviewController.getProductReview);
router.patch('/:productId/:reviewId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.CUSTOMER), productReview_controller_1.ProductReviewController.updateProductReview);
router.delete('/:productId/:reviewId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.CUSTOMER), productReview_controller_1.ProductReviewController.deleteProductReview);
